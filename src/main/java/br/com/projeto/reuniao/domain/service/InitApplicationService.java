...
public class InitApplicationService {
    ...
    public void initializeTestData() {
    	...
    	if (tipoParticipanteService.countTiposParticipante() == 0) {
    		tipoParticipanteService.insertTipoParticipante(new TipoParticipante("Solicitante", "Pessoa responsável por agendar e informar todos os dados necessários para marcar a reunião."));
